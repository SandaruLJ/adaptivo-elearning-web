...
const QuizDisplay = () => {
  ...
  return (
    <div className="quiz_container">
      <Button variant="outlined" className="button-cancel">
        Cancel
      </Button>
      <FormControl>
        <FormLabel id="demo-radio-buttons-group-label">
          {" "}
          {
            <Box component="div" fontSize={30}>
              <Interweave content={quiz[0].question} />
            </Box>
          }
        </FormLabel>
          ...
          <FormControlLabel
            ...
            label={
              <Box component="div" fontSize={20}>
                <Interweave content={quiz[0].answers[0]} />
              </Box>
            }
          />
          <FormControlLabel
            ...
            label={
              <Box component="div" fontSize={20}>
                <Interweave content={quiz[0].answers[1]} />
              </Box>
            }
          />
          <FormControlLabel
            ...
            label={
              <Box component="div" fontSize={20}>
                <Interweave content={quiz[0].answers[2]} />
              </Box>
            }
          />
          <FormControlLabel
            ...
            label={
              <Box component="div" fontSize={20}>
                <Interweave content={quiz[0].answers[3]} />
              </Box>
            }
          />
          <FormControlLabel
            ...
            label={
              <Box component="div" fontSize={20}>
                <Interweave content={quiz[0].answers[4]} />
              </Box>
            }
          />
        </RadioGroup>
